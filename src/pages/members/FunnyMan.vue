    ...
    >
      <header class="mb-4">
        <section class="flex flex-col place-items-center text-center">
          ...
          <h1 class="text-2xl font-bold">Funny Man</h1>
          <div
            class="flex flex-col w-3/4 md:w-1/2 lg:flex-row lg:justify-center lg:w-full"
          >
            <div class="flex justify-center mt-4 mb-4">
              <g-image src="../../../static/assets/Funny_Man_V.png"></g-image>
            </div>
            <ul
              class="flex flex-col m-4 justify-center place-items-center text-xs lg:w-1/3 lg:pl-6 lg:text-sm"
            >
              <li class="w-full text-left">
                Real Name: <strong>Dylan Peter Alvarez</strong>
              </li>
              <li class="w-full text-left">
                Stage Name: <strong>Funny Man King Kong</strong>
              </li>
              <li class="w-full text-left">
                Born: <date><strong>April 11, 1986</strong> </date>
              </li>
              <li class="w-full text-left">
              ...
              <li class="w-full text-left">
                Position:
                <strong>vocals, backing vocals</strong>
              </li>
              <li class="w-full text-left">Song Count: 50</li>
            </ul>
          </div>
        </section>
      </header>
